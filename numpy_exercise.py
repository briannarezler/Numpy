...
print("smallest sale", np.min(salesArray))
print("largest sale", np.max(salesArray))
...
new_array = salesArray * 0.02
print(new_array)

total_fees = np.sum(new_array)
print(total_fees)

print()

## Step 6: Using your fee array and salesArray, calculate how much profit Superstore
#  made for each sale after paying credit card fees.
# Store this in a new array and print it.
print(
    "-----------------------------------------------   STEP SIX  -----------------------------------------------"
)
profit_array = [total_sales - total_fees]
print(profit_array)
...
new_array = np.append(salesArray, [newRegister], axis=0)
print(new_array)
